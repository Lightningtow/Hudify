...
////							if (lightningtow.hudify.util.HudifyHUD.getDuration() < lightningtow.hudify.util.HudifyHUD.getProgress()) {
////								Thread.sleep(1000);
...
////								} else {
////									lightningtow.hudify.util.HudifyHUD.updateData(data);
////								}
////							} else if (SpotifyUtil.isPlaying()) {
////								lightningtow.hudify.util.HudifyHUD.setProgress(lightningtow.hudify.util.HudifyHUD.getProgress() + 1000);
////							}
////						} else {
////							lightningtow.hudify.util.HudifyHUD.setProgress(0);
////							lightningtow.hudify.util.HudifyHUD.setDuration(-1);
//						}
...
//						player.sendMessage(Text.of(lightningtow.hudify.util.HudifyHUD.hudInfo[5]));
//						return 0;
//					})
//			);
//		});
